...
In scenarios where the marginal likelihood is not easily obtained, one may express the postierior distribution  as:
...
In sports modelling the use of log linear random effect modells for the parameters $\lambda_{1i}$ and $\lambda_{2i}$ is common [Karlis et al. 2003]. Using a simple baseline model of the 
